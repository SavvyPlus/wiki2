...
<div class="page-metadata">Created by <span class="author">Andrew Dodds</span>, last modified on Jun 05, 2017</div>
...
Compilation requires Python and a number of additional libraries to be installed. For details of libraries/versions installed see [Python Libraries](https://savvyplus.atlassian.net/wiki/display/ITProc/Python+Libraries) page.
